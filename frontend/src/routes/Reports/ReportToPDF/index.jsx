...
export const generatePDF = (report) => {
  ...
  const title = `${report.incident_type === 'bicycle_accident' ? 'Bicycle accident' : 
                report.incident_type === 'bicycle_theft' ? 'Bicycle theft' :
                report.incident_type === 'near_miss' ? 'Near miss' :
                'Violation'} at ${report.address}`;
